    ...
    function displayParkingLots(data) {
        ...
        data.forEach(parkinglot => {
            ...
            const parkingLotNameHTML = parkinglot.latitude !== null && parkinglot.longitude !== null
                ? `<a href="https://www.google.com/maps/search/?api=1&query=${parkinglot.latitude},${parkinglot.longitude}" target="_blank"><h3>Route</h3><svg width="26" height="22" viewBox="0 0 26 22" fill="none" xmlns="http://www.w3.org/2000/svg">
